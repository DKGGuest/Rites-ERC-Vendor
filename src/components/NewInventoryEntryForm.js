    ...
    <div className="inventory-entry-form">
      <form onSubmit={handleSubmit}>
        <div className="form-grid">
          ...
          {/* Row 2: Supplier Address (Auto-filled) */}
          ...
          {/* Row 5: Invoice Number & Invoice Date */}
          <div className="form-group">
            <label className="form-label">
          ...
          {/* Row 6: Sub PO Number & Sub PO Date */}
          <div className="form-group">
            <label className="form-label">
          ...
          {/* Row 7: Sub PO Qty & Rate of Material */}
          <div className="form-group">
            <label className="form-label">
          ...
          {/* Row 8: Rate of GST & Declared Quantity */}
          <div className="form-group">
            <label className="form-label">
